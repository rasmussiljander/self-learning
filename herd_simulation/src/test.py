...
class TestInput(unittest.TestCase):
    ...
    def test_bad_numbers(self):
        self.perfect_input = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','1', '2.5']

        self.zero_cars = ['0', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError,check_input,self.zero_cars)

        self.not_all_info = ['40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError,check_input,self.not_all_info)

        self.invalid_size = ['2', '60', '0.05', '0.2', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError,check_input,self.invalid_size)

        self.fm_too_small = ['3', '40', '0.01', '0.2', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.fm_too_small)

        self.fm_too_big = ['3', '40', '0.05', '0.22', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError,check_input,self.fm_too_big)

        self.writing = ['3', '40', 'asdf', 'rasd', '50', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.writing)

        self.lower_bound_bad =  ['3', '40', '0.05', '0.2', '10', '750', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.lower_bound_bad)

        self.upper_bound_bad = ['3', '40', '0.05', '0.2', '50', '800', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.upper_bound_bad)

        self.upper_is_lower = ['3', '40', '0.05', '0.2', '650', '100', '50', '100', '600', '650','1', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.upper_is_lower)

        self.max_speed_low = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','0.5', '2.5']
        self.assertRaises(CarInfoFileError, check_input, self.max_speed_low)

        self.max_speed_high = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','1', '3']
        self.assertRaises(CarInfoFileError, check_input, self.max_speed_high)

        self.max_speed_high_is_low = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','2', '1']
        self.assertRaises(CarInfoFileError, check_input, self.max_speed_high_is_low)

        self.last_text = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','2', 'rs']
        self.assertRaises(CarInfoFileError, check_input, self.last_text)

        self.secondlast_text = ['3', '40', '0.05', '0.2', '50', '750', '50', '100', '600', '650','r', '2']
...
class TestGameLoad(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.titles = ['Number of Cars','Car size','FM L','FM U','Coordinates L','Coordinates U','max speed l','max speed u']
