...
class GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self,world):
        ...
        self.timer.start(10,self)               #Timer event: Important for creating movement! Essential in setting up the
    ...
    def show_window(self):
        ...
        self.view = QtWidgets.QGraphicsView(self.scene,self)        #view must be added for showing the scene
